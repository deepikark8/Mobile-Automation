...
//		driver.executeScript("gesture: dragAndDrop", args);
	...
	public static void dragAndDrop_Pointer_Seq() throws InterruptedException {
		Thread.sleep(5000);
	...
	private static void dragAndDrop_Pointer(AndroidDriver driver, RemoteWebElement source, RemoteWebElement target) {
