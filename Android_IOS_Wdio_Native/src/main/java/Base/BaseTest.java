...
//	
	public WebDriver launchApp(String appType) throws MalformedURLException{
		...
		//	driv er.navi ee
			...
			iosOptions.setCapability("bundleId","org.reactjs.native.example.wdiodemoapp");
			//iosOptions.setChromedriverExecutable("/Users/rahade/workspaceMobileAutomation/Android_Wdio_Native/driver/chromedriver");
			//create object for AndroidDriver / IOSDriver
			IOSDriver driver = new IOSDriver(new URL("http://127.0.0.1:4723/wd/hub"),iosOptions);
			driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(13));
